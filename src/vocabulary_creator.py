...
class VocabularyCreator:
    ...
    def __init__(self, train_set_filename="train_set.json", vocabulary_filename="vocabulary.json"):
        self.train_set = train_set_filename
        self.cleaning = TextCleaning()
        self.vocabulary = vocabulary_filename
        self.voc_data = {}
